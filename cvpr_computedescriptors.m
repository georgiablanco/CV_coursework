...
%OUT_SUBFOLDER='spatialTexture/32x32';
% OUT_SUBFOLDER='spatialTexture/2x2';
%OUT_SUBFOLDER='spatialColourandTexture/8x8';
...
for filenum=1:length(allfiles)
    ...
    %F=ComputeRGBHistogram(img, 9);
    %F=ComputeSpatialColour(img, 32, 32);
    F=ComputeSpatialTexture(img, 4, 4);
    %F=ComputeSpatialTextureColour(img, 8, 8);
